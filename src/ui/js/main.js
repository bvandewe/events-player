...
class MainDashboardController {
  ...
  async init() {
    ...
    if (!this.storageManager.initialized) {
      console.log(
        "[MainDashboard] Waiting for storage manager to initialize...",
      );
  ...
  async onFiltersChanged() {
    ...
    if (this.components.timeline && this.activeTab === "timeline") {
      if (this.components.timeline.autoRefreshEnabled) {
        ...
        console.log(
          "[MainDashboard] Timeline auto-refresh disabled; skipping real-time chart update",
        );
      }
    }
  ...
  async performRealTimeUpdate() {
    ...
    if (this.components.timeline && this.activeTab === "timeline") {
      if (this.components.timeline.autoRefreshEnabled) {
        ...
        console.log(
          "[MainDashboard] Timeline auto-refresh disabled; skipping throttled chart update",
        );
      }
    }
  }
